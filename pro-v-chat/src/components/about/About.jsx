      ...
      <section className="about">
        <div className="about-div1">
          ...
          <div className="about-second">
            ...
            <p>
              Find a sponsor for your idea and get funded by the people who love
              your idea
            </p>
          </div>
        ...
        <div className="about-div2">
          ...
          <p>
            Unlock exclusive opportunities and elevate your brand by partnering
            with us. Get sponsored by top companies and brands, gaining access
            to unique marketing channels and audiences. Enhance your visibility,
            drive growth, and achieve your business goals with strategic
